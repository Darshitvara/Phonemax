        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Your trusted partner for premium mobile devices. We deliver cutting-edge technology with exceptional customer service.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@phonemax.com</span>
              </div>
            </div>
          </div>
        </div>
