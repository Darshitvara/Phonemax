                ...
                <div className="border-t pt-4">
                  <div className="flex items-center space-x-4 mb-4">
                    {order.items.slice(0, 3).map((item) => {
                      ...
                      const altText = item.name || item.product?.name || 'Product image';
                      return (
                        <img
                          key={item.id || `${item.productId}-${altText}`}
                          src={imgSrc}
                          alt={altText}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {order.items.map(item => item.name || item.product?.name).filter(Boolean).join(', ')}
                      </p>
                    </div>
